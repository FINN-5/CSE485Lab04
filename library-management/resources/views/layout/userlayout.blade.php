            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{-- {{route('home.index')}} --}}" class="text-light text-decoration-none">Quản lý sách</a></li>
                        <li><a href="{{-- {{route('home.index')}} --}}" class="text-light text-decoration-none">Quản lý độc giả</a></li>
